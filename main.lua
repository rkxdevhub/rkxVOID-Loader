-- rkxVOID v4.1 Lite - GUI Preto com LED Azul (Versão Free Completa)
-- by rkxdev_hub
...
minimizedIcon.Image = "rbxassetid://10578816197" -- caveira fofa (troque se quiser)
...
local function toggleRun(state)
	runEnabled = state
	if humanoid then
		humanoid.WalkSpeed = runEnabled and 100 or 16 -- padrão 16
	end
end
...
print("rkxVOID v4.1 Lite - Completo carregado!")
